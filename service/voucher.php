...
function getSpecialPromo() {     
	...
	$lastdate = date('Y-m-d');
	//$newdate = "2016-03-08";
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.special_tag,offers.buy_count,offers.quantity FROM offers where DATE(offers.offer_from_date) <=CURDATE() and offers.is_active=1 and offers.is_special=1 and offers.offer_to_date >=:lastdate order by offers.offer_from_date DESC";
        $site_settings = findByIdArray(1,'site_settings');
        //echo $sql;
        $site_path = SITEURL;
...
function getPromoList() {     
	...
	$offer_type_id = 3;
	//$newdate = "2016-03-08";
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.special_tag,offers.buy_count,offers.quantity FROM offers where DATE(offers.offer_from_date) <=CURDATE() and offers.is_active=1 and DATE(offers.offer_to_date) >=:lastdate and offers.offer_type_id !=:offer_type_id order by offers.title";
...
function getExpireSoonPromoList() {
		...
		$offer_type_id = 3;
        $newDate = date('Y-m-d',strtotime('+7 days'));
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.special_tag,offers.buy_count,offers.quantity FROM offers where DATE(offers.offer_from_date) <=CURDATE() and offers.is_active=1 and offers.offer_to_date BETWEEN :start and :end and offers.offer_type_id !=:offer_type_id order by offers.title";
...
function getMenuPromo() {     
	...
	$offer_type_id = 1;
	//$newdate = "2016-03-08";
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.special_tag FROM offers where DATE(offers.offer_from_date) <=CURDATE() and offers.is_active=1 and offers.offer_to_date >=:lastdate and offers.offer_type_id =:offer_type_id order by rand()";
...
function getActiveMembershipPromo() {   
	...
	$todayDate = date('Y-m-d');
	$site_path = SITEURL;	
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.buy_count,offers.quantity FROM offers where DATE(offers.offer_from_date) <=CURDATE() and DATE(offers.offer_to_date) >=CURDATE() and offers.is_active=1 and offers.offer_type_id=3";
...
function getSpecialMembership() {     
	...
	$lastdate = date('Y-m-d');
	//$newdate = "2016-03-08";
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.special_tag FROM offers where DATE(offers.offer_from_date) <=CURDATE() and offers.is_active=1 and offers.is_special=1 and offers.offer_to_date >=:lastdate and offers.offer_type_id=3 ORDER BY offers.offer_from_date DESC";
        $site_settings = findByIdArray(1,'site_settings');
        //echo $sql;
        $site_path = SITEURL;
...
function getActiveMenuPromo() {     
	...
	$site_path = SITEURL;
	//$newdate = "2016-03-08";
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.buy_count,offers.quantity FROM offers where DATE(offers.offer_from_date) <=CURDATE() and DATE(offers.offer_to_date)>= '$todayDate' and offers.is_active=1 and offers.offer_type_id=1";
...
function getSpecialMenuPromo() {     
	...
	$lastdate = date('Y-m-d');
	//$newdate = "2016-03-08";
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.special_tag,offers.buy_count,offers.quantity FROM offers where DATE(offers.offer_from_date) <=CURDATE() and offers.is_active=1 and offers.is_special=1 and DATE(offers.offer_to_date) >=:lastdate and offers.offer_type_id=1 ORDER BY offers.offer_from_date DESC";
...
function getActivePaymentPromo() {     
	...
	$site_path = SITEURL;
	//$newdate = "2016-03-08";
        $sql = "SELECT offers.id,offers.title,offers.price,offers.offer_percent,offers.offer_from_date,offers.offer_to_date,offers.image,offers.buy_count,offers.quantity FROM offers where DATE(offers.offer_from_date) <=CURDATE() and DATE(offers.offer_to_date) >= CURDATE() and offers.is_active=1 and offers.offer_type_id=2";
